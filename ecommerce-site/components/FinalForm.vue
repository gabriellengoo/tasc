<template>
    <div>
      ...
      <!-- Navigation Buttons -->
      <div class="navbutform" v-if="currentChunk !== 3">
        ...
        <button class="nextbtn" v-if="currentChunk < 3" @click="nextStep"> <svg viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
...
export default {
  ...
  methods: {
    nextStep() {
      if (this.currentChunk < 3) this.currentChunk++;
    },
    prevStep() {
